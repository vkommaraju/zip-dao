package com.csc.innovation.entity;
...
@SequenceGenerator(name = "implement_sequence", sequenceName = "implement_id_seq")
public class Implement extends AbstractEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "implement_sequence")
